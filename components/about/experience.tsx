...
function CompanyLogo({ entry }: { entry: Entry }): ReactNode {
  ...
  return (
    <span
      className="ring-foreground/8 relative inline-flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden bg-white ring-1 dark:ring-white/10"
      aria-hidden="true"
      style={{
        borderRadius: 14,
        ...(entry.logoSrc || entry.slug
          ? {}
